...
import com.hzecool.printer.btlibrary.util.PrinterHelper;
...
public class BtCmdService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (action.equals(ConstantDefine.ACTION_PRINT_TEST)) {
            ...
            reSet();
        } else if (action.equals(ConstantDefine.ACTION_PRINT_IMAGE)) {
    ...
    private void printImage(Bitmap bitmap){
        try {
            PrinterHelper.printAreaSize("10", "200", "200", "500", "1");
            PrinterHelper.Expanded("0", "20", bitmap, (byte) 1);
            //PrinterHelper.Form();
            PrinterHelper.Print();
        } catch (Exception e) {
            e.printStackTrace();
